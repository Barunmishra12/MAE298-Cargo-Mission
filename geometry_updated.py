...
# Aspect Ratio
prob.model.add_design_var(av.Aircraft.Wing.ASPECT_RATIO, lower=10.0, upper=16, ref=10.0)
# Wing Area
prob.model.add_design_var(av.Aircraft.Wing.AREA, lower=500.0, upper=1400.0, ref=600.0)
# Wing Sweep
prob.model.add_design_var(av.Aircraft.Wing.SWEEP, lower=0.0, upper=25.0, ref=5.0)
# Taper Ratio
...
# Fuselage Length
prob.model.add_design_var(av.Aircraft.Fuselage.LENGTH, lower=100.0, upper=140.0, ref=125.0)
# Fuselage Max Height
prob.model.add_design_var(av.Aircraft.Fuselage.MAX_HEIGHT, lower=12.0, upper=15.0, ref=13.0)
# Fuselage Max Width
prob.model.add_design_var(av.Aircraft.Fuselage.MAX_WIDTH, lower=12.0, upper=15.0, ref=12.3)
# Horziontal Tail
...
# Boeing 737-9 takeoff wing loading limit
W_S_737 = 142.5  # lb/ft^2

# Tail Volume Ratio Limits
Vh_min = 0.7
Vh_max = 1.2
...
prob.model.add_subsystem(
    ...
    promotes_inputs=[("fuse_length", av.Aircraft.Fuselage.LENGTH)],
    promotes_outputs=["l_h"],
)
...
prob.model.add_subsystem(
    ...
    promotes_inputs=[
        ("area", av.Aircraft.Wing.AREA),
    ],
    promotes_outputs=["wing_loading"],
)

# Correctly connect the MTOW **output** from Aviary
prob.model.connect(
    av.Aircraft.Design.OPERATING_MASS,
    "wing_loading_comp.MTOW"
)
